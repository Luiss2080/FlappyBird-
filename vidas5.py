...
imagen_fondo = pygame.image.load("./Imagenes/FondoVioleta.png").convert()
imagen_pajaro = pygame.image.load("./Imagenes/bird.png").convert_alpha()
tubo_superior = pygame.image.load("./Imagenes/pipe_top.png").convert_alpha()
tubo_inferior = pygame.image.load("./Imagenes/pipe_bot.png").convert_alpha()
imagen_corazon = pygame.image.load("./Imagenes/Corazones.png").convert_alpha()  # Reemplaza con la ruta correcta
